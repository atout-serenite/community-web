(function () {
    ...
    website.add_template_file('/last_articles_block/static/src/xml/lasts_articles_blocks.seo.xml');
    ...
    website.seo2.Suggestion = openerp.Widget.extend({
    ...
    website.seo2.SuggestionList = openerp.Widget.extend({
        ...
        refresh: function () {
            ...
            function addSuggestions (list) {
                ...
                _.each(_.uniq(cleanList), function (keyword) {
                    if (keyword) {
                        var suggestion = new website.seo2.Suggestion(self, {
                            root: self.root,
                            keyword: keyword,
                            page: self.htmlPage,
                        });
    ...
    website.seo2.Keyword = openerp.Widget.extend({
        ...
        start: function () {
            ...
            this.suggestionList = new website.seo2.SuggestionList(this, {
                root: this.keyword,
                page: this.htmlPage,
            });
    ...
    website.seo2.KeywordList = openerp.Widget.extend({
        ...
        add: function (candidate) {
            ...
            if (word && !self.isFull() && !self.exists(word)) {
                var keyword = new website.seo2.Keyword(self, {
                    word: word,
                    page: this.htmlPage,
                });
    ...
    website.seo2.Image = openerp.Widget.extend({
    ...
    website.seo2.ImageList = openerp.Widget.extend({
        init: function (parent, options) {
            this.htmlPage = options.page;
            this._super(parent);
        },
        start: function () {
            ...
            this.htmlPage.images().each(function (index, image) {
                new website.seo2.Image(self, image).appendTo(self.$el);
            });
        },
        images: function () {
            var result = [];
        ...
        add: function (image) {
            new website.seo2.Image(this, image).appendTo(this.$el);
        },
    });

    website.seo2.Preview = openerp.Widget.extend({
    ...
    website.seo2.HtmlPage = openerp.Class.extend(openerp.PropertiesMixin, {
        url: function () {
    ...
    website.seo2.Tip = openerp.Widget.extend({
    ...
    website.seo2.Configurator = openerp.Widget.extend({
        template: 'last_articles_block.seo_configuration',
        events: {
        ...
        start: function () {
            var self = this;
            var $modal = self.$el;
            var htmlPage = this.htmlPage = new website.seo2.HtmlPage();
            ...
            // }
            self.keywordList = new website.seo2.KeywordList(self, { page: htmlPage });
        ...
        renderPreview: function () {
            var preview = new website.seo2.Preview(this, {
    ...
    website.ready().done(function() {
        $(document.body).on('click', 'a[data-action=promote-current-page2]', function() {
            new website.seo2.Configurator(this).appendTo($(document.body));
        });
    });
